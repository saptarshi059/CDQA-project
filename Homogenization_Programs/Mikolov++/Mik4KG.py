...
#python Mik4KG.py --UMLS_Path ../../../Train_KGE/UMLS_KG_MT --BERT_Variant navteca/roberta-base-squad2 --KGE_Variant transd --THROUGH True --TRIPLES False --HS False --PO True
